...
SECRET_KEY = 'django-insecure-t&oyxye=cl1fwc3%rk@7$)lc$c+%c#)=w*%ojqm60nj=2nr@68'
...
#
# # Allow users without a password to reset their password (service providers)
# DJANGO_REST_MULTITOKENAUTH_REQUIRE_USABLE_PASSWORD = False
# DJANGO_REST_PASSWORDRESET_NO_INFORMATION_LEAKAGE = True
# DJANGO_REST_MULTITOKENAUTH_RESET_TOKEN_EXPIRY_TIME = 24 * 7  # one week
